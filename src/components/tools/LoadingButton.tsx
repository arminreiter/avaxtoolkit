...
export function LoadingButton({ loading, children, disabled, className, ...props }: LoadingButtonProps) {
  return (
    <Button disabled={loading || disabled} className={cn("glow-red-sm hover:glow-red transition-shadow uppercase tracking-wider font-display font-semibold", className)} {...props}>
